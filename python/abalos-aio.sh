...
#Auto Dns
wget -O autodns "https://raw.githubusercontent.com/BadBoy-Dexter/Socks/server_script/python/autodns" && chmod +x autodns && sed -i -e 's/\r$//' ~/autodns && ./autodns
