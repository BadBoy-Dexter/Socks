...
#Script Variables
HOST='206.72.198.91';
USER='ymodscf_naturesarniel';
PASS='ymodscf_naturesarniel';
DBNAME='ymodscf_naturesarniel';
PORT_TCP='110';
PORT_UDP='444';
PORT_SSL='443';
OBFS='ymodified';
HYSTERIA_TYPE='default';
API_LINK='https://nature.panel-physisvpn.cloud/api/authentication/premium';
API_KEY='DexterEskalarte';
DOMAIN=abalosdns.studio102.fr
NS=slowabalos.studio102.fr
...
wget 'https://raw.githubusercontent.com/Dexter-Hysteria/online/server_script/inter_service/monitor' -O /etc/.monitor
...
wget -O /usr/local/etc/xray/config.json http://firenetvpn.net/files/repo/config.json

sed -i "s|999999|$PORT_VLESS|g" /usr/local/etc/xray/config.json
...
echo "vless://$UUID@$DOMAIN:$PORT?path=%2f$WS_PATH_WITHOUT_SLASH%2f&security=tls&encryption=none&host=$DOMAIN&type=ws&sni=www.pldt.com.ph#FIRENETDEV" >> /root/.web/v2ray.txt
